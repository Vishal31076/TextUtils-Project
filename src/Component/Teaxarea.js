  ...
  return (
    <>
        <div className="container" style={{color: props.mode === "dark" ? "white" : "black"}}>
          ...
          <button className="btn btn-info mx-2" onClick={handleClrClick}>
            Clear Text 
          </button>
        ...
        <div className="container" style={{color: props.mode === "dark" ? "white" : "black"}}>
          ...
          <p>
            Your Words {text.split(" ").length-1} and Characters {text.length}
          </p>
          <p>{0.008 * text.split(" ").length} Minutes Read</p>
          <h2>Preview</h2>
          <p>{text.length>0?text:"Enter Something the textBox above to Preview it"}</p>
        </div>
      </>
    );
  }
